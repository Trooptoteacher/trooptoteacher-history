...
BODY = r"""
    ...
    <div class="seq">
      ...
      <div class="stage gold">
        <div class="num">4</div>
        <div class="card">
          <div class="lab"><span class="nm">Dawes Act</span><span class="yr">1887</span><span class="q">Communal land split into individual allotments; &ldquo;surplus&rdquo; sold &mdash; whose land was taken?</span></div>
