...
Maps each SSP -> the organizers that build it -> when/where to use it in Unit 1.
...
SSP = [
    ...
    ("SSP.02", "Critically Examine Sources", "red",
     ...
     ["HIPPO", "C&#8209;E&#8209;R"],
     "Any primary source in US.01&ndash;US.07 &mdash; a photo, cartoon, speech, or law."),
    ("SSP.03", "Synthesize Data", "gold",
     "Organize &amp; combine data from several sources into one picture.",
     ["Comparison matrix", "Concept web", "Venn"],
     "US.04 (three forces) &amp; US.07 (old vs. new) &mdash; holding many cases together."),
    ("SSP.04", "Construct &amp; Communicate with Evidence", "navy",
     ...
     "US.05 verdict (Captain vs. Robber Baron) and any claim-and-defend task."),
    ("SSP.05", "Develop Historical Awareness", "red",
     ...
     "US.02 (policy sequence &rarr; Dawes Act) &amp; US.03 (election &rarr; <i>Plessy</i>)."),
    ("SSP.06", "Develop Geographic Awareness", "gold",
     ...
     "US.06 (why cities grew where they did) &amp; every Tennessee Connection."),
]
...
<div class="page">
  <div class="cover">
    <div class="l">
      ...
      <div class="sub">Which organizer builds which practice &mdash; and where it lives in Unit 1</div>
    </div>
  ...
  <div class="stbl">
    <div class="sh"><div>Practice</div><div>What students do</div><div>Build it with</div><div>Use it when &middot; where in Unit 1</div></div>
{chr(10).join(rows)}
  </div>
