...
CSS = r"""
  ...
  .fr-lbl.bl{ bottom:8px; left:12px; } .fr-lbl.br{ bottom:8px; right:12px; }
  ...
  .fr-oval{ position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
    width:30%; height:23%; min-width:170px; background:var(--cream); border:3.5px solid var(--navy);
    border-radius:50%; display:flex; flex-direction:column; align-items:center; justify-content:center;
    text-align:center; z-index:5; box-shadow:0 0 0 6px var(--paper); }
  .fr-oval .k{ font-size:8pt; font-weight:800; letter-spacing:.08em; text-transform:uppercase; color:var(--red); }
  .fr-oval .t{ font-size:11pt; font-weight:800; color:var(--navy); margin-top:2px; }
  .fr-oval .wl{ display:block; width:70%; border-bottom:2px solid var(--navy); height:16px; margin:4px auto 0; }
"""
