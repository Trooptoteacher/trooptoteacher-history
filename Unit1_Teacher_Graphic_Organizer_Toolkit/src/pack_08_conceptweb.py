...
CSS = r"""
  ...
  .hub .htitle{ font-family:Georgia,serif; font-weight:700; font-size:12.5pt; color:var(--navy);
                text-align:center; line-height:1.05; }
  .hub .hsub{ font-size:7.6pt; font-weight:700; color:var(--muted); text-transform:uppercase;
    ...
    <div class="canvas">
      ...
      {_small_html}
        <div class="node hub" style="left:50%; top:50%; width:196px; height:150px;">
          <div class="htitle">CENTRAL<br>IDEA</div>
          <div class="hsub">write it here</div>
        </div>
      </div>
    </div>
"""
