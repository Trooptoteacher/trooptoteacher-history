...
Maps each SSP -> the organizers that build it -> when/where to use it in Unit 8.
...
SSP = [
    ...
    ("SSP.02", "Critically Examine Sources", "red",
     ...
     ["HIPPO", "C&#8209;E&#8209;R"],
     "Any primary source in US.71&ndash;US.77 &mdash; a Levittown ad, a Kennedy&ndash;Nixon debate clip, or a Sun Records single."),
    ("SSP.03", "Synthesize Data", "gold",
     ...
     "US.77 (Kennedy&rsquo;s New Frontier programs) &mdash; holding many cases against one yardstick."),
    ("SSP.04", "Construct &amp; Communicate with Evidence", "navy",
     ...
     "US.73 (the polio vaccine &amp; the interstates) &amp; US.71 (the suburban ideal) &mdash; weigh benefits &amp; costs."),
    ("SSP.05", "Develop Historical Awareness", "red",
     ...
     "US.72 (the baby boom&rsquo;s ripple effects) &amp; US.76 (swing &rarr; R&amp;B &rarr; rock &rsquo;n&rsquo; roll)."),
    ("SSP.06", "Develop Geographic Awareness", "gold",
     "Read place, region &amp; spatial patterns; connect geography to events.",
     ["Suburban map", "&#9733; Tennessee Connection"],
     "US.74 (interstates &amp; suburban sprawl) &mdash; and every Tennessee Connection (Sun Records, WSM&#8209;TV, I&#8209;40)."),
]
...
<div class="page">
  <div class="cover">
    <div class="l">
      ...
      <div class="sub">Which organizer builds which practice &mdash; and where it lives in Unit 8</div>
    </div>
  ...
  <div class="stbl">
    <div class="sh"><div>Practice</div><div>What students do</div><div>Build it with</div><div>Use it when &middot; where in Unit 8</div></div>
{chr(10).join(rows)}
  </div>
