...
Apply when artifact_type is `question-item`. This builds on the `tcap-item-writer-v2` and `tn-assessment-specialist` user skills but focuses on accessibility-specific concerns.
