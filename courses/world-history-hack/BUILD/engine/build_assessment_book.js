...
const cover=[
 new Paragraph({spacing:{before:1400,after:0},children:[R((U.brand||'Course').toUpperCase()+'™',{s:30,b:true,c:GOLD})]}),
 ...
 callout('HOW TO USE THIS BOOK',[
   ...
   'All items are pulled from the '+(U.brand||'Course')+'™ question bank. '+A.disclosure,
...
const key=[H('Part 4 — Teacher Answer Key + Item Analysis + Reteach',1,{brk:true}),
 callout('READING THE ANALYSIS',['Each item shows its standard, DOK, correct key, and reporting category, plus a reteach move. Distractor-based routing: a wrong choice signals which idea to reteach — pair with the workbook Cornell notes and Guided Support. '+A.disclosure]),
