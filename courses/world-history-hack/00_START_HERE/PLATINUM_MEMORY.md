...
- [~] **Phase 3** — per-unit content JSON (`BUILD/unitN/analysis/unitN_content.json`) → historian fact-check. Schema contract extracted → `BUILD/CONTENT_SCHEMA.md`. NEXT: prove one reference unit end-to-end, then fan out remaining units; run historian-factcheck after.
