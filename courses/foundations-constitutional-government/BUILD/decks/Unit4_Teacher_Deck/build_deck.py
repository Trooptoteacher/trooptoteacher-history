...
CONTENT = os.path.join(HERE, "..", "..", "unit4", "analysis", "unit4_content.json")
IMAGES = os.path.join(HERE, "unit4_images.json")
ASSETS = HERE  # image 'file' paths in the manifest are relative to this folder
OUT = os.path.join(HERE, "pages", "unit4_teacher_deck.html")
