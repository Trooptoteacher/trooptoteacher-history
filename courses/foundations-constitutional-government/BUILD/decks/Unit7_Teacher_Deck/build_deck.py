# -*- coding: utf-8 -*-
"""Unit 7 Teacher Deck — one continuous teacher deck for Foundations of
Constitutional Government (GC.28-GC.30, Tennessee State and Local Government),
built to the platinum standard. Unit chrome is parameterized from the content JSON.
...
# ---- unit chrome (parameterized — no hardcoded unit number / standards range) ----
UNIT = U.get("code", "Unit 7")           # e.g. "Unit 7"
RANGE = U.get("standards_range", "")     # e.g. "GC.28–GC.30"
NSTD = len(ORDER)
...
FOOT = f"Government Hack&trade; &middot; Foundations of Constitutional Government &middot; {UNIT} Teacher Deck"
...
slide(f"""
  <div class="shead"><div class="l"><div class="kick">{UNIT} &middot; Roadmap</div><h2>Where We Are Going</h2></div>
    <div class="r"><span class="chip">{NSTD} standards</span><span class="chip ssp">SSP.01&ndash;06</span></div></div>
  <div class="big-eq">
