...
CONTENT = os.path.join(HERE, "..", "..", "unit2", "analysis", "unit2_content.json")
IMAGES = os.path.join(HERE, "unit2_images.json")
ASSETS = HERE  # image 'file' paths in the manifest are relative to this folder
OUT = os.path.join(HERE, "pages", "unit2_teacher_deck.html")
