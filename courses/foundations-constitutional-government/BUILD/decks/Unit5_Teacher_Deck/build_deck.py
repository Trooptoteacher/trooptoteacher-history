...
CONTENT = os.path.join(HERE, "..", "..", "unit5", "analysis", "unit5_content.json")
IMAGES = os.path.join(HERE, "unit5_images.json")
ASSETS = HERE  # image 'file' paths in the manifest are relative to this folder
OUT = os.path.join(HERE, "pages", "unit5_teacher_deck.html")
...
<title>Unit 1 Teacher Deck &mdash; Foundations of Constitutional Government</title>
