...
CONTENT = os.path.join(HERE, "..", "..", "unit3", "analysis", "unit3_content.json")
IMAGES = os.path.join(HERE, "unit3_images.json")
ASSETS = HERE  # image 'file' paths in the manifest are relative to this folder
OUT = os.path.join(HERE, "pages", "unit3_teacher_deck.html")
