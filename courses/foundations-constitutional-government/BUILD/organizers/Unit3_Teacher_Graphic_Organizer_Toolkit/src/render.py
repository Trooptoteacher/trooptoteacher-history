...
ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # unit root (src/ is one level down)
...
def render_pdf_combined():
    ...
    for h in htmls:
        ...
        parts.append(p)
    out = os.path.join(EXPORTS, "Unit3_Government_Hack_Graphic_Organizer_Toolkit.pdf")
