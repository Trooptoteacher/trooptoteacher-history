...
ROWS = [
    ...
    ("Put steps <b>in order</b> / show a process", "Timeline &middot; Sequence", "red",
     "Sequence exposes how one step makes the next possible. <i>Builds SSP.05.</i>", "15&ndash;20"),
    ...
    ("<b>Analyze a source</b>", "HIPPO", "red",
...
TN_ROW = ("Connect the <b>nation</b> to <b>Tennessee</b>", "&#9733; Tennessee Connection",
          "Local ties make national civics stick &mdash; and it&rsquo;s what sets Government Hack apart. <b>Our signature move.</b>", "10&ndash;15")
...
<div class="page">
  <div class="cover">
    <div class="l">
      <div class="ttl"><span class="thin">Government Hack &middot; Teacher Graphic Organizer Toolkit</span>Which Organizer, When?</div>
      <div class="sub">Unit 1 &middot; Foundations of Constitutional Government &nbsp;(GC.01&ndash;GC.09)</div>
    </div>
    <div class="r">
