...
// Items pulled from the canonical question bank (unit7_assessment.json). Platinum tokens.
...
const UNIT=JSON.parse(fs.readFileSync('analysis/unit7_content.json','utf8')).unit;
