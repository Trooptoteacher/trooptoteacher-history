...
consolidated Government question bank, mirroring the U.S. History flagship all_questions.json
...
def sk(it):
    m=re.match(r"GC\.(\d+)",str(it.get("standard",""))); n=int(m.group(1)) if m else 999
