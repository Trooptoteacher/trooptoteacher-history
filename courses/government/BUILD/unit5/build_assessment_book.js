...
// Items pulled from the canonical question bank (unit5_assessment.json). Platinum tokens.
...
const UNIT=JSON.parse(fs.readFileSync('analysis/unit5_content.json','utf8')).unit;
