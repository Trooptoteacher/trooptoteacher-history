...
Maps each SSP -> the organizers that build it -> when/where to use it in Unit 2.
...
SSP = [
    ...
    ("SSP.02", "Critically Examine Sources", "red",
     ...
     ["HIPPO", "C&#8209;E&#8209;R"],
     "Any primary source in US.08&ndash;US.18 &mdash; a photo, cartoon, speech, or data table."),
    ("SSP.03", "Synthesize Data", "gold",
     "Organize &amp; combine data from several sources into one picture.",
     ["Comparison matrix", "Concept web", "Venn"],
     "US.14 (muckraker matrix) &amp; US.15 (Progressive reforms) &mdash; holding many cases together."),
    ("SSP.04", "Construct &amp; Communicate with Evidence", "navy",
     ...
     "US.09 (Washington vs. Du Bois) verdict &amp; the TR-vs-Wilson judgment."),
    ("SSP.05", "Develop Historical Awareness", "red",
     "Sequence in time, trace cause &amp; effect, and see change over time.",
     ["Timeline", "Cause &amp; Effect", "Sequence"],
     "US.12 (trusts &rarr; antitrust) &amp; US.18 (suffrage &rarr; the 19th Amendment)."),
    ("SSP.06", "Develop Geographic Awareness", "gold",
     "Read place, region &amp; spatial patterns; connect geography to events.",
     ["City &times; Industry matrix", "&#9733; Tennessee Connection"],
     "US.10/US.11 (farmers &amp; labor geography) &amp; every Tennessee Connection."),
]
...
<div class="page">
  <div class="cover">
    <div class="l">
      ...
      <div class="sub">Which organizer builds which practice &mdash; and where it lives in Unit 2</div>
    </div>
  ...
  <div class="stbl">
    <div class="sh"><div>Practice</div><div>What students do</div><div>Build it with</div><div>Use it when &middot; where in Unit 2</div></div>
{chr(10).join(rows)}
  </div>
