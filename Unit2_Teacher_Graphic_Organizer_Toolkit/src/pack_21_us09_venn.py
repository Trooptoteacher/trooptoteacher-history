    ...
    <div class="canvas">
      <div class="venn-wrap">
        <svg viewBox="0 0 900 560" preserveAspectRatio="xMidYMid meet" font-family="Helvetica Neue, Arial, sans-serif">
          ...
          <g text-anchor="middle" font-weight="800" font-size="13" fill="#9aa2b2" letter-spacing="0.5">
            <text x="205" y="120">ONLY WASHINGTON</text>
            <text x="695" y="120" fill="#caa8ad">ONLY DU BOIS</text>
          ...
          <g text-anchor="middle" font-style="italic" font-weight="600" font-size="12.5" fill="#9aa2b2">
            <text x="205" y="228">Tuskegee</text>
            <text x="205" y="248">vocational skills</text>
            <text x="205" y="268">Atlanta Compromise</text>
          </g>
          <g text-anchor="middle" font-style="italic" font-weight="600" font-size="12.5" fill="#caa8ad">
            <text x="695" y="228">Talented Tenth</text>
            <text x="695" y="248">NAACP</text>
            <text x="695" y="268">immediate rights</text>
          </g>
          ...
          <g stroke="#B9C2D0" stroke-width="1.2" stroke-dasharray="2 5">
            <line x1="130" y1="315" x2="290" y2="315"/><line x1="120" y1="353" x2="290" y2="353"/><line x1="130" y1="391" x2="290" y2="391"/><line x1="150" y1="429" x2="285" y2="429"/></g>
          <g stroke="#D8B3B7" stroke-width="1.2" stroke-dasharray="2 5">
            <line x1="610" y1="315" x2="770" y2="315"/><line x1="610" y1="353" x2="780" y2="353"/><line x1="610" y1="391" x2="770" y2="391"/><line x1="615" y1="429" x2="750" y2="429"/></g>
