    ...
    <div class="canvas">
      ...
      <div class="venn-wrap">
        <svg viewBox="0 0 900 560" preserveAspectRatio="xMidYMid meet">
          ...
          <text x="204" y="150" text-anchor="middle" font-family="Georgia,serif" font-size="18" font-weight="700" fill="#1B2A4A">Only Yalta</text>
          <text x="450" y="92" text-anchor="middle" font-family="Georgia,serif" font-size="17" font-weight="700" fill="#8a6a1e">Both</text>
          <text x="690" y="151" text-anchor="middle" font-family="Georgia,serif" font-size="18" font-weight="700" fill="#B22234">Only Potsdam</text>
