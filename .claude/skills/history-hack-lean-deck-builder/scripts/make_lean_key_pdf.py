...
SRC = '/home/user/workspace/Unit1_Lean_Teacher_Answer_Key.md'
OUT = '/home/user/workspace/hh-web/public/downloads/tcap-decks/unit-1-lean/Unit1_Lean_Teacher_Answer_Key.pdf'
...
while i < len(lines):
    ...
    elif ln.strip().startswith('*') and ln.strip().endswith('*') and '**' not in ln and not intro_done:
