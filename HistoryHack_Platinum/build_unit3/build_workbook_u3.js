// Unit 3 Course Standard STUDENT WORKBOOK — docx-js, EXACT Unit 5 template (no deviation).
...
const HERO={file:'analysis/assets/hero.jpg', w:1200, h:967,
  cap:'Colonel Theodore Roosevelt and the Rough Riders atop San Juan Heights, Cuba, 1898.',
  cred:'William Dinwiddie / Library of Congress. Public domain.'};
...
const cover=[
  ...
  P(R('UNIT 3',{s:52,b:true,c:RED}),{align:AlignmentType.CENTER,spacing:{after:60}}),
  P(R('Imperialism and World War I, 1890–1920',{s:32,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:120}}),
  P(R('COURSE STANDARD EDITION',{s:26,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:60}}),
  P(R('US.19 – US.27   •   9 Tennessee U.S. History Standards   •   Grades 9–12',{s:22,c:INK}),{align:AlignmentType.CENTER,spacing:{after:140}}),
  ...coverHero(HERO),
  callout('TENNESSEE CONNECTION · SERGEANT ALVIN C. YORK',['Over 90,000 Tennesseans served in World War I. Alvin C. York of Pall Mall, Fentress County, became one of the most decorated American soldiers of the war — on October 8, 1918 he helped capture 132 German soldiers and earned the Medal of Honor (US.24–US.25).']),
...
const front=[
  ...
  P(R('U.S. History Hack™ — Unit 3: Imperialism and World War I (1890–1920), Course Standard Edition.',{s:22,b:true})),
  ...
  P(R('Framework stack. This workbook anchors to Tennessee U.S. History standards US.19–US.27 and the Social Studies Practices (SSP.01–SSP.06), and is designed on CAST UDL 3.0 and an MTSS support model.',{s:22})),
...
function block(code){
  ...
  out.push(callout('PREVIEW & PREDICT',['Which learning target will be hardest, and why? Connect it to the unit’s big question: who decided, who benefited, and who bore the costs?']));
  ...
  out.push(callout('BIG-QUESTION ORGANIZER — as the U.S. became a world power and went to war, who decided, who benefited, and who bore the costs?',['Jot quick notes from THIS standard: Who benefited? · Who bore the costs? · Who decided?']));
  out.push(...ruled(2));
...
const back=[
  ...
  callout('TENNESSEE CONNECTION · SERGEANT ALVIN C. YORK',['Over 90,000 Tennesseans served in World War I. Alvin C. York of Pall Mall, Fentress County — a farmer who first sought conscientious-objector status — became one of the most decorated American soldiers of the war. On October 8, 1918, in the Argonne Forest, he helped capture 132 German soldiers and earned the Medal of Honor. Tennessee’s “Volunteer State” tradition (US.21) runs straight through the war (US.24–US.25). Cordell Hull of Pickett County later helped found the United Nations and won the Nobel Peace Prize (US.27).']),
  ...
  H('Empire and War — Who Decided, and Who Paid?',1),
  P(R('This section complicates the imperialism-and-war narrative: who made the decisions, who benefited, and who bore the costs at home and abroad. It is History Hack-authored instructional synthesis grounded in this unit’s sourced record — not a primary source.',{s:22})),
  ...[['Newly Colonized Peoples','The Spanish-American War made the U.S. an empire (US.21): Cubans, Puerto Ricans, Filipinos, and Pacific Islanders came under U.S. control — the Philippines only after a brutal war of resistance. Debates over intervention pitted expansionists against anti-imperialists (US.19–US.20).'],
    ['Soldiers & Draftees','Once the U.S. entered the war (US.24), millions were drafted (US.25). Over 90,000 Tennesseans served; Sergeant Alvin C. York of Fentress County became one of the most decorated soldiers of the war.'],
    ['The Home Front','Mobilization reshaped daily life (US.26): war industries, propaganda, and rationing — but also the Espionage and Sedition Acts, which curbed dissent, and new opportunities and tensions for women and Black Americans who moved for war work.'],
    ['The Postwar World','Wilson’s Fourteen Points promised a peace “without victory” and a League of Nations (US.27); the Senate’s rejection of the League showed the limits of that vision. Cordell Hull of Tennessee would carry the idea forward decades later.']
  ...
  H('Unit Reflection',2),
  P(R('Return to the unit’s big question: as the United States became a world power and went to war, who made the decisions, who benefited, and who bore the costs — at home and abroad? Write a final claim with two pieces of evidence from different standards.',{s:22})),
...
// ================= ASSEMBLE =================
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 3 · Course Standard Edition',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:0},children:[
  R('U.S. History Hack™ · Unit 3 (Course Standard)   © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:15,c:GREY}),
  new TextRun({children:[PageNumber.CURRENT],size:15,color:GREY,bold:true,font:FONT})]})]});
const doc=new Document({creator:'TroopToTeacher Technologies LLC',title:'U.S. History Hack — Unit 3 Course Standard Student Workbook (Pilot)',
  ...
  sections:[{properties:{page:{size:{width:12240,height:15840},margin:{top:1152,bottom:1152,left:1296,right:1296,header:720,footer:720}}},
    headers:{default:header},footers:{default:footer},children: SAMPLE ? [P(R(`SAMPLE — Unit 3 · first ${SAMPLE} standards (activities only, ruled-line writing) — for review`,{s:24,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:120}}), ...standards] : [...cover,...front,...standards,...back]}]});
