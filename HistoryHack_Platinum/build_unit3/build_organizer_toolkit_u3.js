...
// ---------- ASSEMBLE ----------
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 3 · Teacher Graphic Organizer Toolkit',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:0},children:[R('U.S. History Hack™ · Unit 3 (Course Standard) © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:16,c:GREY}),new TextRun({children:[PageNumber.CURRENT],size:16,color:GREY,font:FONT})]})]});
...
const cover=[
 ...
 new Paragraph({spacing:{after:200},children:[R('Unit 3 — Imperialism and World War I (1890–1920)  ·  Reproducible',{s:26,c:INK})]}),
...
Packer.toBuffer(doc).then(b=>{fs.writeFileSync('deliverables/Unit3_Teacher_Graphic_Organizer_Toolkit.docx',b);console.log('WROTE toolkit',b.length,'bytes');});
