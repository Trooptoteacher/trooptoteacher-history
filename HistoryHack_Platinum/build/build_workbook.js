...
const cover=[
  ...
  P(R('US.01 – US.07   •   7 Tennessee U.S. History Standards   •   Grades 9–12',{s:22,c:INK}),{align:AlignmentType.CENTER,spacing:{after:300}}),
  callout('TENNESSEE CONNECTION · WILLIAMSON COUNTY',['A hometown hero: George Jordan of Triune, Williamson County — the only Medal of Honor recipient from our county. He served with the 9th U.S. Cavalry (the Buffalo Soldiers), earning the Medal of Honor for Fort Tularosa (1880) and Carrizo Canyon (1881).']),
...
const back=[
  ...
  callout('TENNESSEE CONNECTION · WILLIAMSON COUNTY',['George Jordan of Triune (Williamson County) is the only Medal of Honor recipient from our county. A Buffalo Soldier of the 9th U.S. Cavalry, he was recognized for Fort Tularosa (1880) and Carrizo Canyon (1881). His story links the westward expansion of US.01 to the people of our own community.']),
  ...
  H('Representation in the Industrial Era — Reached and Left Out',1),
  P(R('This section complicates the industrial-era narrative: who it reached, who it excluded, and who organized in response. It is History Hack-authored instructional synthesis grounded in this unit’s sourced record — not a primary source.',{s:22})),
  ...[['American Indian Nations','Westward expansion and the Transcontinental Railroad (US.01) crossed treaty lands; reservation, assimilation, boarding-school, and Dawes Act policy (US.02) cut tribal holdings from about 138 million acres to 48 million by 1934.'],
    ...
    ['African Americans','The Compromise of 1877 ended Reconstruction’s protections (US.03); the Exodusters migrated to Kansas, while Madam C.J. Walker and George Washington Carver (US.05) built enterprise and innovation under Jim Crow.'],
  ...
  H('Unit Reflection',2),
  P(R('Return to the unit’s big question: as the United States industrialized, who benefited and who bore the costs? Write a final claim with two pieces of evidence from different standards.',{s:22})),
