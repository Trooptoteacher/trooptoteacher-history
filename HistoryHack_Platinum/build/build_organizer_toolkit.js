...
const PART2=[
 [...organizer('US.01 — Who Benefited vs. Who Bore the Costs (T-Chart)','This standard weighs the impact of the Homestead Act & Transcontinental Railroad. A T-chart makes the trade-off explicit: settlers/railroads gained; American Indian nations bore the costs.',tchart('Who benefited (settlers, railroads, U.S.)','Who bore the costs (American Indian nations)')), TN('George Jordan of Williamson County — a Buffalo Soldier (9th U.S. Cavalry, Medal of Honor) — anchors this westward-expansion standard to our own community.')],
 organizer('US.02 — Federal Indian Policy Over Time (Cause & Effect / Sequence)','The standard lists policies that built on one another. A cause→effect flow shows how each policy led to the next: reservations → assimilation → boarding schools → the Dawes Act (1887).',causeEffect()),
 organizer('US.03 — End of Reconstruction to Plessy (Timeline)','This standard is a sequence of turning points. A timeline makes the chronology and cause/effect clear: 1876 election → Compromise of 1877 → Jim Crow & disenfranchisement → Plessy v. Ferguson (1896).',timeline()),
 organizer('US.04 — Farmers vs. Wage Earners vs. Industrial Capitalists (Matrix)','The standard names the economic difference among three groups. A 3-column matrix compares them across the same criteria (work, power, wealth, political voice).',matrix(['Criterion','Farmers','Wage earners','Industrial capitalists'],['Kind of work','Economic power','Political voice','Biggest challenge'],2)),
 organizer('US.05 — Captains of Industry vs. Robber Barons (T-Chart)','The SAME business leaders can be read two ways. A T-chart makes students weigh the evidence for each lens before judging.',tchart('“Captain of Industry” evidence','“Robber Baron” evidence')),
 organizer('US.06 — Industrial Centers by Industry (Matrix)','The standard asks students to LOCATE cities and connect them to industry. A city × industry matrix organizes the comparison.',matrix(['City','Known for (industry)','Why here (geography)'],['Boston','Chicago','New York City','Pittsburgh','San Francisco'],2)),
 organizer('US.07 — “Old” vs. “New” Immigrants (Venn)','The standard literally asks students to describe the DIFFERENCES. A Venn (with a shared middle) captures origin, culture, and experience — and what both groups had in common.',venn2('Only “old” immigrants','Both / shared','Only “new” immigrants')),
];
...
// ---------- ASSEMBLE ----------
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 1 · Teacher Graphic Organizer Toolkit',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{before:0},children:[R('U.S. History Hack™ · Unit 1 (Course Standard) © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:16,c:GREY}),new TextRun({children:[PageNumber.CURRENT],size:16,color:GREY,font:FONT})]})]});
...
const cover=[
 ...
 new Paragraph({spacing:{after:200},children:[R('Unit 1 — The Rise of Industrialization (1877–1900)  ·  Reproducible',{s:26,c:INK})]}),
