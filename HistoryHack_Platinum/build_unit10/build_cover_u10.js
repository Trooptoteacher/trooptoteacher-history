// Unit 10 — Professional COVER WRAPS (front · spine · back + spec) for EVERY book.
...
const HERO='analysis/assets/hero.jpg'; const HERO_W=1280, HERO_H=1010;
const HERO_CRED='Reagan at the Brandenburg Gate, 1987 · Reagan Library / U.S. National Archives · Public domain';
...
function buildCover(spec){
  ...
  const front=fullPanel([
    ...
    P(R('MODERN',{s:56,b:true,c:WHITE,caps:true}),{align:AlignmentType.CENTER,spacing:{after:0}}),
    P(R('AMERICA',{s:58,b:true,c:GOLD,caps:true}),{align:AlignmentType.CENTER,spacing:{after:20}}),
    P(R('1965–2016',{s:30,b:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:60}}),
    new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},border:{top:{style:BorderStyle.SINGLE,size:14,color:RED,space:6},bottom:{style:BorderStyle.SINGLE,size:14,color:RED,space:6}},children:[R('  Unit 10  ·  High-School U.S. History  ·  Standards-Aligned  ',{s:20,b:true,c:WHITE})]}),
    ...heroImg,
  ...
  const spineTxt=new TableCell({width:{size:900,type:WidthType.DXA},verticalAlign:VerticalAlign.CENTER,
    ...
    children:[new Paragraph({alignment:AlignmentType.CENTER,children:[
      ...
      R('Unit 10 — Modern America (1965–2016)      ',{s:22,b:true,c:WHITE}),
  ...
  const backTop=fullPanel([
    ...
    P(R(`Unit 10 — Modern America (1965–2016)  ·  ${spec.audience}`,{s:19,i:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:20}}),
  ...
  const backBody=[
    ...
    P(R('INSIDE THIS UNIT — the thirteen standards',{s:21,b:true,c:NAVY,caps:true}),{spacing:{before:120,after:30}}),
    rule(2400,RED,28),
...
const SPECS=[
 {out:'Unit10_Cover_Student_Workbook.docx', designation:'STUDENT WORKBOOK', audience:'Student Edition', pages:133,
  ...
  listingTitle:'U.S. History Hack™ — Unit 10: Modern America (1965–2016) · Student Workbook',
  keywords:'U.S. history workbook, high school history, UDL curriculum, MTSS, CER writing, primary source analysis, Cornell notes, standards-aligned, modern America, Great Society, Watergate, Reagan, end of the Cold War, September 11, Obama, information age, environmentalism, standards-aligned, TCAP review',
  blurb:'U.S. History Hack™ turns a full unit of high-school U.S. History into one student-ready workbook that reaches every learner without lowering the bar. Built on Universal Design for Learning (UDL 3.0) and Multi-Tiered Systems of Support (MTSS), each of the thirteen standards moves from a core lesson to Cornell notes paired with the slide deck, real Library-of-Congress primary sources analyzed with HIPPO, evidence-based writing on a 6-point CER rubric, and a formative Exit Ticket with a built-in reteach path. Standards-aligned, DOK-balanced, and TCAP-ready — with a companion Assessment Book of two parallel forms. Unit 10 covers Modern America, 1965–2016.'},

 {out:'Unit10_Cover_Teacher_Edition.docx', designation:'TEACHER EDITION', audience:'Teacher Edition', pages:16,
  ...
  listingTitle:'U.S. History Hack™ — Unit 10: Modern America · Teacher How-to-Use & MTSS Guide',
  ...
  blurb:'The Teacher Edition for U.S. History Hack™ Unit 10 gives you the full teaching system: a one-standard-one-period pacing map with honest activity time estimates, the MTSS decision cycle, standards/SSP and dimension crosswalks, the 6-point CER rubric, teacher-side answer keys with reteach routing, and the deck-plus-Cornell workflow. Designed on UDL 3.0 so the rigor stays the same for every learner.'},

 {out:'Unit10_Cover_Assessment_Book.docx', designation:'ASSESSMENT BOOK', audience:'Teacher Edition', pages:27,
 ...
 {out:'Unit10_Cover_Organizer_Toolkit.docx', designation:'GRAPHIC ORGANIZER TOOLKIT', audience:'Teacher Edition', pages:47,
  ...
  listingTitle:'U.S. History Hack™ — Unit 10 · Teacher Graphic Organizer Toolkit',
