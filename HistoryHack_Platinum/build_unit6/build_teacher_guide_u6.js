// Unit 6 Teacher How-to-Use & MTSS Guide — docx-js, EXACT Unit 5 template tokens/structure.
...
const body=[
  H('Unit 6 — Teacher How-to-Use & MTSS Guide',1),
  P(Rr('World War II (1939–1945) · Course Standard · US.45–US.58 · Grades 9–12',{s:22,b:true,c:NAVY})),
  ...
  dataTable(['Criterion','Where it shows'],[
    ['Standards alignment (US.45–58)','Standards & SSP Crosswalk; per-standard blocks.'],
  ...
  callout('De-biased key distribution (Transfer Checks, US.45–US.58)',['A · B · C · D · A · B · C · D · A · B · C · D · A · B']),
  ...
  H('11. How CAST UDL 3.0 Is Visible in Unit 6',1),
