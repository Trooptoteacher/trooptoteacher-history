// Unit 6 — TEACHER Assessment Book (Formative + Summative Form A/B + Teacher Key/Analysis).
...
// ---- COVER + front ----
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 6 · Assessment Book (Teacher)',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,children:[R('U.S. History Hack™ · Unit 6 (Course Standard) © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:16,c:GREY}),new TextRun({children:[PageNumber.CURRENT],size:16,color:GREY,font:FONT})]})]});
const cover=[
 ...
 new Paragraph({spacing:{after:200},children:[R('Unit 6 — World War II (1939–1945)  ·  Teacher Edition',{s:26})]}),
