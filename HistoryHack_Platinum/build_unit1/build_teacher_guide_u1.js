...
const body=[
  ...
  P(Rr('The Rise of Industrialization (1877–1900) · Course Standard · US.01–US.07 · Grades 9–12',{s:22,b:true,c:NAVY})),
  ...
  callout('De-biased key distribution (Transfer Checks, US.01–US.07)',['A · B · C · D · A · B · C · D · A · B · C']),
...
const header=new Header({children:[P(Rr('U.S. History Hack™ · Unit 1 Teacher Guide',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:0},children:[
  Rr('U.S. History Hack™ · Unit 1 Teacher Guide   © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:15,c:GREY}),
  new TextRun({children:[PageNumber.CURRENT],size:15,color:GREY,bold:true,font:FONT})]})]});
const doc=new Document({creator:'TroopToTeacher Technologies LLC',title:'U.S. History Hack — Unit 1 Teacher How-to-Use & MTSS Guide (Pilot)',
