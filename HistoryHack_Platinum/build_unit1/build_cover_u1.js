...
const HERO='analysis/assets/hero.jpg'; const HERO_W=1200, HERO_H=957;
const HERO_CRED='The Golden Spike ceremony, Promontory Summit, Utah, 1869 · Andrew J. Russell / U.S. National Archives · Public domain';
...
function buildCover(spec){
  ...
  const front=fullPanel([
    ...
    P(R('INDUSTRIAL',{s:52,b:true,c:WHITE,caps:true}),{align:AlignmentType.CENTER,spacing:{after:0}}),
    P(R('AMERICA',{s:56,b:true,c:GOLD,caps:true}),{align:AlignmentType.CENTER,spacing:{after:20}}),
    P(R('1877–1900',{s:30,b:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:60}}),
    new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},border:{top:{style:BorderStyle.SINGLE,size:14,color:RED,space:6},bottom:{style:BorderStyle.SINGLE,size:14,color:RED,space:6}},children:[R('  Unit 1  ·  High-School U.S. History  ·  Standards-Aligned  ',{s:20,b:true,c:WHITE})]}),
    ...heroImg,
  ...
  const backTop=fullPanel([
    ...
    P(R(`Unit 1 — The Rise of Industrialization (1877–1900)  ·  ${spec.audience}`,{s:19,i:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:20}}),
...
const SPECS=[
 {out:'Unit1_Cover_Student_Workbook.docx', designation:'STUDENT WORKBOOK', audience:'Student Edition', pages:76,
  ...
  listingTitle:'U.S. History Hack™ — Unit 1: The Rise of Industrialization (1877–1900) · Student Workbook',
  keywords:'U.S. history workbook, high school history, UDL curriculum, MTSS, CER writing, primary source analysis, Cornell notes, standards-aligned, industrialization, Gilded Age, transcontinental railroad, Homestead Act, robber barons, Carnegie, Rockefeller, immigration, Ellis Island, urbanization, Jim Crow, standards-aligned, TCAP review',
 ...
 {out:'Unit1_Cover_Teacher_Edition.docx', designation:'TEACHER EDITION', audience:'Teacher Edition', pages:13,
  ...
  listingTitle:'U.S. History Hack™ — Unit 1: The Rise of Industrialization · Teacher How-to-Use & MTSS Guide',
  ...
  blurb:'The Teacher Edition for U.S. History Hack™ Unit 1 gives you the full teaching system: a one-standard-one-period pacing map with honest activity time estimates, the MTSS decision cycle, standards/SSP and dimension crosswalks, the 6-point CER rubric, teacher-side answer keys with reteach routing, and the deck-plus-Cornell workflow. Designed on UDL 3.0 so the rigor stays the same for every learner.'},

 {out:'Unit1_Cover_Assessment_Book.docx', designation:'ASSESSMENT BOOK', audience:'Teacher Edition', pages:16,
  ...
  listingTitle:'U.S. History Hack™ — Unit 1: The Rise of Industrialization · Assessment Book (Teacher)',
 ...
 {out:'Unit1_Cover_Organizer_Toolkit.docx', designation:'GRAPHIC ORGANIZER TOOLKIT', audience:'Teacher Edition', pages:35,
  ...
  listingTitle:'U.S. History Hack™ — Unit 1 · Teacher Graphic Organizer Toolkit',
