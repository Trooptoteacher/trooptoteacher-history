...
const HERO={file:'analysis/assets/hero.jpg', w:1200, h:957,
  cap:'The Golden Spike ceremony completing the Transcontinental Railroad, Promontory Summit, Utah, May 10, 1869.',
  cred:'Andrew J. Russell / U.S. National Archives. Public domain.'};
...
const cover=[
  ...
  P(R('The Rise of Industrialization, 1877–1900',{s:32,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:120}}),
  P(R('COURSE STANDARD EDITION',{s:26,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:60}}),
  P(R('US.01 – US.07   •   7 Tennessee U.S. History Standards   •   Grades 9–12',{s:22,c:INK}),{align:AlignmentType.CENTER,spacing:{after:140}}),
  ...coverHero(HERO),
  callout('TENNESSEE CONNECTION · WILLIAMSON COUNTY & GEORGE JORDAN',['A hometown hero connects our county to the westward expansion of this unit (US.01–US.02). George Jordan of Triune in Williamson County served with the 9th U.S. Cavalry — the “Buffalo Soldiers” — on the western frontier, and earned the Medal of Honor for his defense of Fort Tularosa (1880) and Carrizo Canyon (1881). His story ties the settlement of the West, the railroads, and the federal government’s campaigns against Native nations to the people of our own community.']),
...
const front=[
  ...
  P(R('U.S. History Hack™ — Unit 1: The Rise of Industrialization (1877–1900), Course Standard Edition.',{s:22,b:true})),
...
function block(code){
  ...
  out.push(callout('BIG-QUESTION ORGANIZER — as America industrialized, who built the new economy, who profited, and who paid the price?',['Jot quick notes from THIS standard: Who benefited? · Who bore the costs? · Who decided?']));
  out.push(...ruled(2));
...
const back=[
  ...
  callout('TENNESSEE CONNECTION · WILLIAMSON COUNTY & THE BUFFALO SOLDIERS',['Our own county is woven into the story of the industrializing nation. George Jordan of Triune, in Williamson County, is the only Medal of Honor recipient from the county. He served with the 9th U.S. Cavalry — the “Buffalo Soldiers,” regiments of Black soldiers who patrolled the western frontier — and was honored for his defense of Fort Tularosa, New Mexico (1880) and Carrizo Canyon (1881) (US.01–US.02). Tennessee itself industrialized fast in these decades: railroads, coal mining on the Cumberland Plateau, and iron and textile mills reshaped the state’s economy — even as the convict-lease system and Jim Crow (US.03) shaped who benefited and who bore the costs.']),
  ...
  P(R('Industrialization touched Tennessee directly — railroads, coal mines, iron works, and textile mills, and the people who worked them. Investigate one local connection and record what you find.',{s:22})),
  ...
  H('The Rise of Industrialization — Four Threads',1),
  P(R('This section connects the threads of the era: how the nation settled a continent, abandoned Reconstruction, built an industrial economy, and became a land of cities and immigrants — and who benefited and who bore the costs. It is History Hack-authored instructional synthesis grounded in this unit’s sourced record — not a primary source.',{s:22})),
  ...[['Taming a Continent','The transcontinental railroad, the Homestead Act, and a flood of settlers transformed the West into farms, ranches, and mining towns (US.01) — a conquest that came at devastating cost to the Native nations who were forced onto reservations by federal policy (US.02).'],
    ['A Promise Abandoned','Reconstruction ended with the Compromise of 1877, and Southern states built the Jim Crow system — segregation, disenfranchisement, and the “separate but equal” doctrine upheld in Plessy v. Ferguson — that would stand for generations (US.03).'],
    ['An Industrial Colossus','New inventions, cheap steel, oil, and new ways of organizing business (trusts and vertical integration) built an industrial economy of staggering scale and immense private fortunes — the Gilded Age, its wealth shadowed by corruption and inequality (US.04, US.05).'],
    ['A Nation of Cities and Newcomers','Industry pulled millions into booming, crowded cities and drew a new wave of immigrants from southern and eastern Europe and Asia, remaking American society (US.06, US.07) — even as tenement poverty and nativist backlash revealed the era’s costs.']
  ].flatMap(([h,b])=>[H(h,2),P(R(b,{s:21}))]),
  H('Unit Reflection',2),
  P(R('Return to the unit’s big question: as America industrialized, who built the new economy, who profited, and who paid the price? Write a final claim with two pieces of evidence from different standards.',{s:22})),
...
// ================= ASSEMBLE =================
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 1 · Course Standard Edition',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:0},children:[
  R('U.S. History Hack™ · Unit 1 (Course Standard)   © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:15,c:GREY}),
  new TextRun({children:[PageNumber.CURRENT],size:15,color:GREY,bold:true,font:FONT})]})]});
const doc=new Document({creator:'TroopToTeacher Technologies LLC',title:'U.S. History Hack — Unit 1 Course Standard Student Workbook (Pilot)',
...
const OUTFILE=SAMPLE?`deliverables/Unit1_SAMPLE_${SAMPLE}standards.docx`:'deliverables/Unit1_Student_Workbook_CourseStandard.docx';
