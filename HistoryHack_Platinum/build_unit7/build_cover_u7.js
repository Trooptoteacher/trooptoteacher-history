// Unit 7 — Professional COVER WRAPS (front · spine · back + spec) for EVERY book.
...
const HERO='analysis/assets/hero.jpg'; const HERO_W=1200, HERO_H=937;
const HERO_CRED='Construction of the Berlin Wall, 1961 · U.S. National Archives · Public domain';
...
function buildCover(spec){
  ...
  const front=fullPanel([
    ...
    P(R('THE',{s:44,b:true,c:WHITE,caps:true}),{align:AlignmentType.CENTER,spacing:{after:0}}),
    P(R('COLD WAR',{s:66,b:true,c:GOLD,caps:true}),{align:AlignmentType.CENTER,spacing:{after:20}}),
    P(R('1945–1991',{s:30,b:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:60}}),
    new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},border:{top:{style:BorderStyle.SINGLE,size:14,color:RED,space:6},bottom:{style:BorderStyle.SINGLE,size:14,color:RED,space:6}},children:[R('  Unit 7  ·  High-School U.S. History  ·  Standards-Aligned  ',{s:20,b:true,c:WHITE})]}),
    ...heroImg,
  ...
  const spineTxt=new TableCell({width:{size:900,type:WidthType.DXA},verticalAlign:VerticalAlign.CENTER,
    ...
    children:[new Paragraph({alignment:AlignmentType.CENTER,children:[
      ...
      R('Unit 7 — The Cold War (1945–1991)      ',{s:22,b:true,c:WHITE}),
  ...
  const backTop=fullPanel([
    ...
    P(R(`Unit 7 — The Cold War (1945–1991)  ·  ${spec.audience}`,{s:19,i:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:20}}),
  ...
  const backBody=[
    ...
    P(R('INSIDE THIS UNIT — the twelve standards',{s:21,b:true,c:NAVY,caps:true}),{spacing:{before:120,after:30}}),
    rule(2400,RED,28),
...
const SPECS=[
 {out:'Unit7_Cover_Student_Workbook.docx', designation:'STUDENT WORKBOOK', audience:'Student Edition', pages:125,
  ...
  listingTitle:'U.S. History Hack™ — Unit 7: The Cold War (1945–1991) · Student Workbook',
  keywords:'U.S. history workbook, high school history, UDL curriculum, MTSS, CER writing, primary source analysis, Cornell notes, standards-aligned, Cold War, containment, McCarthyism, Korean War, Vietnam War, Cuban Missile Crisis, Space Race, Berlin Wall, standards-aligned, TCAP review',
  blurb:'U.S. History Hack™ turns a full unit of high-school U.S. History into one student-ready workbook that reaches every learner without lowering the bar. Built on Universal Design for Learning (UDL 3.0) and Multi-Tiered Systems of Support (MTSS), each of the twelve standards moves from a core lesson to Cornell notes paired with the slide deck, real Library-of-Congress primary sources analyzed with HIPPO, evidence-based writing on a 6-point CER rubric, and a formative Exit Ticket with a built-in reteach path. Standards-aligned, DOK-balanced, and TCAP-ready — with a companion Assessment Book of two parallel forms. Unit 7 covers The Cold War, 1945–1991.'},

 {out:'Unit7_Cover_Teacher_Edition.docx', designation:'TEACHER EDITION', audience:'Teacher Edition', pages:15,
  ...
  listingTitle:'U.S. History Hack™ — Unit 7: The Cold War · Teacher How-to-Use & MTSS Guide',
  ...
  blurb:'The Teacher Edition for U.S. History Hack™ Unit 7 gives you the full teaching system: a one-standard-one-period pacing map with honest activity time estimates, the MTSS decision cycle, standards/SSP and dimension crosswalks, the 6-point CER rubric, teacher-side answer keys with reteach routing, and the deck-plus-Cornell workflow. Designed on UDL 3.0 so the rigor stays the same for every learner.'},

 {out:'Unit7_Cover_Assessment_Book.docx', designation:'ASSESSMENT BOOK', audience:'Teacher Edition', pages:27,
 ...
 {out:'Unit7_Cover_Organizer_Toolkit.docx', designation:'GRAPHIC ORGANIZER TOOLKIT', audience:'Teacher Edition', pages:45,
  ...
  listingTitle:'U.S. History Hack™ — Unit 7 · Teacher Graphic Organizer Toolkit',
