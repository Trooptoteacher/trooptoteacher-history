// Unit 7 Course Standard STUDENT WORKBOOK — docx-js, EXACT Unit 5 template (no deviation).
...
const HERO={file:'analysis/assets/hero.jpg', w:1200, h:937,
  cap:'East German workers construct the Berlin Wall, 1961.',
...
const cover=[
  ...
  P(R('UNIT 7',{s:52,b:true,c:RED}),{align:AlignmentType.CENTER,spacing:{after:60}}),
  P(R('The Cold War, 1945–1991',{s:32,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:120}}),
  P(R('COURSE STANDARD EDITION',{s:26,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:60}}),
  P(R('US.59 – US.70   •   12 Tennessee U.S. History Standards   •   Grades 9–12',{s:22,c:INK}),{align:AlignmentType.CENTER,spacing:{after:140}}),
  ...coverHero(HERO),
  callout('TENNESSEE CONNECTION · TENNESSEE IN THE COLD WAR',['Tennessee sat on the front lines of the Cold War. Oak Ridge’s Y-12 plant kept enriching uranium for the nuclear arms race (US.59, US.64). Fort Campbell’s airborne units fought in Korea (US.62) and Vietnam (US.66). Senator Estes Kefauver’s televised hearings made him a national figure (US.60–US.61); Senator Albert Gore Sr. became an early critic of the Vietnam War (US.67); and the Arnold Engineering Center at Tullahoma tested rockets for the Space Race (US.69).']),
...
const front=[
  ...
  P(R('U.S. History Hack™ — Unit 7: The Cold War (1945–1991), Course Standard Edition.',{s:22,b:true})),
  ...
  P(R('Framework stack. This workbook anchors to Tennessee U.S. History standards US.59–US.70 and the Social Studies Practices (SSP.01–SSP.06), and is designed on CAST UDL 3.0 and an MTSS support model.',{s:22})),
...
function block(code){
  ...
  out.push(callout('PREVIEW & PREDICT',['Which learning target will be hardest, and why? Connect it to the unit’s big question: how did the Cold War shape life at home and U.S. actions abroad, and at what cost?']));
  ...
  out.push(callout('BIG-QUESTION ORGANIZER — in the Cold War, how did the fear of communism shape American life at home and its actions abroad — and at what cost?',['Jot quick notes from THIS standard: Who benefited? · Who bore the costs? · Who decided?']));
  out.push(...ruled(2));
...
const back=[
  ...
  callout('TENNESSEE CONNECTION · TENNESSEE IN THE COLD WAR',['Tennessee was woven through the entire Cold War. Oak Ridge’s Y-12 plant, built for the Manhattan Project, kept enriching uranium for the nuclear arms race that defined the era (US.59, US.64). Fort Campbell’s airborne soldiers deployed to Korea (US.62) and, later, through multiple tours in Vietnam (US.66). In politics, Senator Estes Kefauver won national fame chairing televised hearings on organized crime (US.60–US.61); Senator Albert Gore Sr. broke with his party as an early, outspoken critic of the Vietnam War (US.67); and Senator Howard Baker later played a key role in Cold War diplomacy (US.70). Tennessee even reached for space: the Arnold Engineering Development Complex at Tullahoma tested the rockets and engines of the Space Race (US.69). Campuses like Vanderbilt and the University of Tennessee became centers of anti-war activism (US.68).']),
  ...
  H('Cold War at Home and Abroad — Fear, Freedom, and Cost',1),
  P(R('This section complicates the Cold War narrative: the fight against communism reshaped American life and the wider world, and it came with real costs — abroad and at home. It is History Hack-authored instructional synthesis grounded in this unit’s sourced record — not a primary source.',{s:22})),
  ...[['Containment Turned Hot','A policy of containment (US.60) pulled the U.S. into shooting wars in Korea (US.62) and Vietnam (US.66–US.67), and to the brink of nuclear war over Cuba (US.65). The “domino theory” justified intervention across the globe.'],
    ['Fear at Home','The Second Red Scare and McCarthyism (US.61) ruined careers and chilled dissent; nuclear fear reshaped daily life with fallout shelters and “duck and cover” drills (US.64). Security and suspicion pressed against civil liberties.'],
    ['A Divided Home Front','Vietnam split the country (US.68): the draft, campus protests, and events like Kent State set a generation against the war, even as a “silent majority” backed it.'],
    ['Competition and Thaw','The Cold War was also a race for prestige — the Space Race to the Moon (US.69) — and, eventually, a thaw: détente, arms-control talks, and the fall of the Berlin Wall in 1989 (US.70) that ended the era.']
  ...
  H('Unit Reflection',2),
  P(R('Return to the unit’s big question: how did the fear of communism shape American life at home and U.S. actions abroad — and at what cost? Write a final claim with two pieces of evidence from different standards.',{s:22})),
...
// ================= ASSEMBLE =================
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 7 · Course Standard Edition',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:0},children:[
  R('U.S. History Hack™ · Unit 7 (Course Standard)   © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:15,c:GREY}),
  new TextRun({children:[PageNumber.CURRENT],size:15,color:GREY,bold:true,font:FONT})]})]});
const doc=new Document({creator:'TroopToTeacher Technologies LLC',title:'U.S. History Hack — Unit 7 Course Standard Student Workbook (Pilot)',
  ...
  sections:[{properties:{page:{size:{width:12240,height:15840},margin:{top:1152,bottom:1152,left:1296,right:1296,header:720,footer:720}}},
    headers:{default:header},footers:{default:footer},children: SAMPLE ? [P(R(`SAMPLE — Unit 7 · first ${SAMPLE} standards (activities only, ruled-line writing) — for review`,{s:24,b:true,c:NAVY}),{align:AlignmentType.CENTER,spacing:{after:120}}), ...standards] : [...cover,...front,...standards,...back]}]});
const OUTFILE=SAMPLE?`deliverables/Unit7_SAMPLE_${SAMPLE}standards.docx`:'deliverables/Unit7_Student_Workbook_CourseStandard.docx';
