// Unit 4 Teacher How-to-Use & MTSS Guide — docx-js, EXACT Unit 5 template tokens/structure.
...
const body=[
  H('Unit 4 — Teacher How-to-Use & MTSS Guide',1),
  P(Rr('The 1920s (1920–1929) · Course Standard · US.28–US.38 · Grades 9–12',{s:22,b:true,c:NAVY})),
  ...
  callout('De-biased key distribution (Transfer Checks, US.28–US.38)',['A · B · C · D · A · B · C · D · A · B · C']),
  ...
  H('11. How CAST UDL 3.0 Is Visible in Unit 4',1),
...
const header=new Header({children:[P(Rr('U.S. History Hack™ · Unit 4 Teacher Guide',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:0},children:[
  Rr('U.S. History Hack™ · Unit 4 Teacher Guide   © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:15,c:GREY}),
  new TextRun({children:[PageNumber.CURRENT],size:15,color:GREY,bold:true,font:FONT})]})]});
const doc=new Document({creator:'TroopToTeacher Technologies LLC',title:'U.S. History Hack — Unit 4 Teacher How-to-Use & MTSS Guide (Pilot)',
...
Packer.toBuffer(doc).then(b=>{fs.writeFileSync('deliverables/Unit4_Teacher_HowToUse_and_MTSS_Guide.docx',b);console.log('WROTE teacher guide',b.length,'bytes');});
