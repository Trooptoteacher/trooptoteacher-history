// Unit 4 — Professional COVER WRAPS (front · spine · back + spec) for EVERY book.
...
const HERO='analysis/assets/hero.jpg'; const HERO_W=1021, HERO_H=689;
const HERO_CRED='A Ford assembly line in the era of mass production, early 1900s · Public domain';
...
function buildCover(spec){
  ...
  const front=fullPanel([
    ...
    P(R('THE ROARING',{s:52,b:true,c:WHITE,caps:true}),{align:AlignmentType.CENTER,spacing:{after:0}}),
    P(R('TWENTIES',{s:56,b:true,c:GOLD,caps:true}),{align:AlignmentType.CENTER,spacing:{after:20}}),
    P(R('1920–1929',{s:30,b:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:60}}),
    new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},border:{top:{style:BorderStyle.SINGLE,size:14,color:RED,space:6},bottom:{style:BorderStyle.SINGLE,size:14,color:RED,space:6}},children:[R('  Unit 4  ·  High-School U.S. History  ·  Standards-Aligned  ',{s:20,b:true,c:WHITE})]}),
    ...heroImg,
  ...
  const spineTxt=new TableCell({width:{size:900,type:WidthType.DXA},verticalAlign:VerticalAlign.CENTER,
    ...
    children:[new Paragraph({alignment:AlignmentType.CENTER,children:[
      ...
      R('Unit 4 — The 1920s (1920–1929)      ',{s:22,b:true,c:WHITE}),
  ...
  const backTop=fullPanel([
    ...
    P(R(`Unit 4 — The 1920s (1920–1929)  ·  ${spec.audience}`,{s:19,i:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:20}}),
...
const SPECS=[
 {out:'Unit4_Cover_Student_Workbook.docx', designation:'STUDENT WORKBOOK', audience:'Student Edition', pages:115,
 ...
 {out:'Unit4_Cover_Teacher_Edition.docx', designation:'TEACHER EDITION', audience:'Teacher Edition', pages:15,
  ...
  listingTitle:'U.S. History Hack™ — Unit 4: The 1920s · Teacher How-to-Use & MTSS Guide',
  ...
  blurb:'The Teacher Edition for U.S. History Hack™ Unit 4 gives you the full teaching system: a one-standard-one-period pacing map with honest activity time estimates, the MTSS decision cycle, standards/SSP and dimension crosswalks, the 6-point CER rubric, teacher-side answer keys with reteach routing, and the deck-plus-Cornell workflow. Designed on UDL 3.0 so the rigor stays the same for every learner.'},

 {out:'Unit4_Cover_Assessment_Book.docx', designation:'ASSESSMENT BOOK', audience:'Teacher Edition', pages:25,
 ...
 {out:'Unit4_Cover_Organizer_Toolkit.docx', designation:'GRAPHIC ORGANIZER TOOLKIT', audience:'Teacher Edition', pages:43,
  ...
  listingTitle:'U.S. History Hack™ — Unit 4 · Teacher Graphic Organizer Toolkit',
