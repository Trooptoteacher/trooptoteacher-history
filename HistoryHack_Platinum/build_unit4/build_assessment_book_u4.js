// Unit 4 — TEACHER Assessment Book (Formative + Summative Form A/B + Teacher Key/Analysis).
...
const A=JSON.parse(fs.readFileSync('analysis/unit4_assessment.json','utf8'));
...
// ---- COVER + front ----
const header=new Header({children:[P(R('U.S. History Hack™ · Unit 4 · Assessment Book (Teacher)',{s:16,b:true,c:GOLD}),{align:AlignmentType.RIGHT,spacing:{after:0}})]});
const footer=new Footer({children:[new Paragraph({alignment:AlignmentType.CENTER,children:[R('U.S. History Hack™ · Unit 4 (Course Standard) © 2026 TroopToTeacher Technologies LLC   |   Page ',{s:16,c:GREY}),new TextRun({children:[PageNumber.CURRENT],size:16,color:GREY,font:FONT})]})]});
const cover=[
 ...
 new Paragraph({spacing:{after:200},children:[R('Unit 4 — The 1920s (1920–1929)  ·  Teacher Edition',{s:26})]}),
