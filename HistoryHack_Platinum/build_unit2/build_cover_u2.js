// Unit 2 — Professional COVER WRAPS (front · spine · back + spec) for EVERY book.
...
const HERO='analysis/assets/hero.jpg'; const HERO_W=1536, HERO_H=1204;
const HERO_CRED='Pennsylvania Avenue, Washington, D.C., early 1900s · Library of Congress · Public domain';  // no verified public-domain hero image for this unit — typographic cover
...
function buildCover(spec){
  ...
  const front=fullPanel([
    ...
    P(R('THE PROGRESSIVE',{s:52,b:true,c:WHITE,caps:true}),{align:AlignmentType.CENTER,spacing:{after:0}}),
    P(R('ERA',{s:52,b:true,c:GOLD,caps:true}),{align:AlignmentType.CENTER,spacing:{after:20}}),
    P(R('1890–1920',{s:30,b:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:60}}),
    new Paragraph({alignment:AlignmentType.CENTER,spacing:{after:40},border:{top:{style:BorderStyle.SINGLE,size:14,color:RED,space:6},bottom:{style:BorderStyle.SINGLE,size:14,color:RED,space:6}},children:[R('  Unit 2  ·  High-School U.S. History  ·  Standards-Aligned  ',{s:20,b:true,c:WHITE})]}),
    ...heroImg,
  ...
  const spineTxt=new TableCell({width:{size:900,type:WidthType.DXA},verticalAlign:VerticalAlign.CENTER,
    ...
    children:[new Paragraph({alignment:AlignmentType.CENTER,children:[
      ...
      R('Unit 2 — The Progressive Era (1890–1920)      ',{s:22,b:true,c:WHITE}),
  ...
  const backTop=fullPanel([
    ...
    P(R(`Unit 2 — The Progressive Era (1890–1920)  ·  ${spec.audience}`,{s:19,i:true,c:WHITE}),{align:AlignmentType.CENTER,spacing:{after:20}}),
...
const SPECS=[
 {out:'Unit2_Cover_Student_Workbook.docx', designation:'STUDENT WORKBOOK', audience:'Student Edition', pages:115,
 ...
 {out:'Unit2_Cover_Teacher_Edition.docx', designation:'TEACHER EDITION', audience:'Teacher Edition', pages:15,
  ...
  listingTitle:'U.S. History Hack™ — Unit 2: The Progressive Era · Teacher How-to-Use & MTSS Guide',
  ...
  blurb:'The Teacher Edition for U.S. History Hack™ Unit 2 gives you the full teaching system: a one-standard-one-period pacing map with honest activity time estimates, the MTSS decision cycle, standards/SSP and dimension crosswalks, the 6-point CER rubric, teacher-side answer keys with reteach routing, and the deck-plus-Cornell workflow. Designed on UDL 3.0 so the rigor stays the same for every learner.'},

 {out:'Unit2_Cover_Assessment_Book.docx', designation:'ASSESSMENT BOOK', audience:'Teacher Edition', pages:25,
 ...
 {out:'Unit2_Cover_Organizer_Toolkit.docx', designation:'GRAPHIC ORGANIZER TOOLKIT', audience:'Teacher Edition', pages:43,
  ...
  listingTitle:'U.S. History Hack™ — Unit 2 · Teacher Graphic Organizer Toolkit',
