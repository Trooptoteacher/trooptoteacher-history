...
**One document, leveled and scaffolded for an inclusion class.** Standard US.01.
**Built:** 2026-08-11 (UTC) · print-first via WeasyPrint (no .docx).
**Generator:** `print-pipeline/gen_homestead_closeread.py`
**Deliverable:** `US01_Homestead_CloseRead_*.pdf` (4 pp)
...
- Supports work **alongside — never in place of** — a student's IEP/504 accommodations.

## Integrity
Statute text is a **verbatim public-domain excerpt** of the Homestead Act of 1862 (12 Stat. 392; 8 sections; approved May 20, 1862), verified against the U.S. National Archives, NPS, Gilder Lehrman, and the State Historical Society of North Dakota transcript. The simpler-English and Spanish versions are clearly labeled **retellings/translations for access — not** presented as the primary source. America 250 palette; ™ not ®; ISBN "[to be assigned]"; version timestamp in filename + on-page.

## QC
Rendered and inspected every page: 4 pp, no split tables, no orphan/sparse pages; body ≥10.4 pt; Spanish reviewed for accuracy.
